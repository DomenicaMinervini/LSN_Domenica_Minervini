...
int nspin;
const int sim=31; //esegue la simulazione 31 volte, per 31 diversi valori della temperatura
double J,h,low_t; //low_t è la temperatura assegnata nel file input.dat
double beta[sim], temp[sim];
