...
void Blocchi_1s(int E, int L, int N, double mean[], double square[]){
   ...
   fstream g;
   g.open("coordinate_1s.dat",ios::out);
   ...
   g.close();
   cout << "E' stato prodotto il file 'coordinate_1s.dat'." << endl;
   rnd.SaveSeed();   
}
...
void Media_1s(int L, int M, int N, double mean[], double square[]){
   ...
   f.close();
   cout << "E' stato prodotto il file 'raggi_1s.dat'." << endl;
   cout << "-----------------------------------------" << endl;
...
void Blocchi_2p(int E, int L, int N, double mean[], double square[]){
   ...
   //PARTE 3: ALGORITMO DI METROPOLIS; SIMULAZIONE VERA E PROPRIA
   fstream g;
   g.open("coordinate_2p.dat",ios::out);
   ...
   g.close();
   cout << "E' stato prodotto il file 'coordinate_2p.dat'." << endl;
   rnd.SaveSeed();   
}
...
void Media_2p(int L, int M, int N, double mean[], double square[]){
   ...
   f.close();
   cout << "E' stato prodotto il file 'raggi_2p.dat'." << endl;
   cout << "-----------------------------------------" << endl;
